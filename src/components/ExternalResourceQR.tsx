...
export function ExternalResourceQR({ label, title, description, url, compact = false }: ExternalResourceQRProps) {
      ...
      <div className="border border-slate-200 bg-white rounded-xl p-3 flex flex-col justify-between items-center text-center gap-2 transition-all hover:bg-slate-50 hover:shadow-3xs h-full">
        ...
        <div className="space-y-1 flex flex-col items-center w-full">
          <div className="flex flex-col items-center gap-1">
            <span className="bg-[#FF6600] text-white font-mono font-bold text-[8.5px] px-2 py-0.5 rounded tracking-wider uppercase">
              {label}
            </span>
            <span className="text-[8.5px] uppercase font-bold tracking-widest text-slate-400 flex items-center justify-center gap-1">
        ...
        <div className="flex flex-col items-center shrink-0 w-full">
          ...
          <div className="mt-1">
            <a
              ...
              className="inline-flex items-center gap-1 text-[9.5px] font-extrabold text-[#004080] hover:text-[#FF6600] transition-colors uppercase tracking-wider"
            >
              Open Resource
